...
public class KaoqinController {
	 ...
	 */
	@RequestMapping
	public void index(Map<String, Object>out,String rIds,Kaoqin kaoqin,String year,String month,String allFlag) throws ParseException, UnsupportedEncodingException{
	...
	@RequestMapping
	public ModelAndView doAdd(Map<String, Object>out,String rid,String timeWork,String day) throws IOException, ParseException{
		...
		do{
			...
			for (String id : idArr) {
				...
				kaoqin.setGmtWork(DateUtil.getDate(day, "yyyy-MM-dd"));
				Float tw = Float.valueOf(timeWork);
				kaoqin.setTimeWork(tw);
